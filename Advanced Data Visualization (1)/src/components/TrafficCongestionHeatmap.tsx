...
export function TrafficCongestionHeatmap() {
  ...
  return (
    <div className="space-y-6">
      {/* Analysis Insight */}
      <Card className="p-5 bg-gradient-to-r from-red-50 to-orange-50 border-red-200">
        <div className="space-y-2">
          <h3 className="text-slate-900">📊 Congestion Forecast Impact (2024→2034)</h3>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Label htmlFor="high-congestion-filter" className="text-slate-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="p-5 border-l-4 border-orange-500">
          <div className="space-y-2">
            <p className="text-slate-500">Average Congestion</p>
            <p className="text-slate-900 text-2xl">{avgCongestion.toFixed(1)}%</p>
            <p className="text-slate-600">Across all zones</p>
          </div>
        </Card>
        <Card className="p-5 border-l-4 border-red-500">
          <div className="space-y-2">
            <p className="text-slate-500">Most Congested</p>
            <p className="text-slate-900 text-2xl">
              {maxCongestionZone.Zone} - {maxCongestionZone.CongestionLevel}%
            </p>
            <p className="text-slate-600">{maxCongestionZone.Region}</p>
          </div>
        </Card>
        <Card className="p-5 border-l-4 border-green-500">
          <div className="space-y-2">
            <p className="text-slate-500">Least Congested</p>
            <p className="text-slate-900 text-2xl">
              {minCongestionZone.Zone} - {minCongestionZone.CongestionLevel}%
            </p>
            <p className="text-slate-600">{minCongestionZone.Region}</p>
          </div>
        </Card>
      </div>
      ...
      <Tabs defaultValue="heatmap" className="w-full">
          ...
          <Card className="p-6 space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <h3 className="text-slate-900">Zone-wise Congestion Gradient</h3>
              ...
              <div className="flex gap-2">
                <Badge variant={timeView === "current" ? "default" : "outline"}>
                  2024 Current
                </Badge>
                <Badge variant={timeView === "predicted" ? "default" : "outline"}>
                  2034 Predicted
                </Badge>
              </div>
            </div>
        ...
        <TabsContent value="comparison" className="space-y-4">
          <Card className="p-6 space-y-4">
            <div className="space-y-1">
              <h3 className="text-slate-900">Current vs Predicted Congestion (2034)</h3>
              <p className="text-slate-500">
            ...
            <div className="h-[400px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={congestionChartData}>
                  ...
                  <XAxis dataKey="zone" />
                  <YAxis domain={[0, 100]} label={{ value: "Congestion %", angle: -90, position: "insideLeft" }} />
          ...
          <Card className="p-6 space-y-4">
            <div className="space-y-1">
              <h3 className="text-slate-900">Projected Congestion Increase</h3>
              <p className="text-slate-500">Percentage point change by 2034</p>
            </div>
            <div className="space-y-2">
              {congestionChartData
        ...
        <TabsContent value="temporal" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Morning/Evening patterns (mock data) */}
            <Card className="p-6 space-y-4">
              <div className="space-y-1">
                <h3 className="text-slate-900">Peak Hours Analysis</h3>
                <p className="text-slate-500">Average congestion by time of day</p>
              </div>
              <div className="space-y-3">
                <div>
                  <div className="flex justify-between mb-1">
                    <span className="text-slate-600">Morning Peak (8-10 AM)</span>
                ...
                <div>
                  <div className="flex justify-between mb-1">
                    <span className="text-slate-600">Midday (12-2 PM)</span>
                ...
                <div>
                  <div className="flex justify-between mb-1">
                    <span className="text-slate-600">Evening Peak (6-8 PM)</span>
                ...
                <div>
                  <div className="flex justify-between mb-1">
                    <span className="text-slate-600">Night (10 PM-6 AM)</span>
            ...
            <Card className="p-6 space-y-4">
              <div className="space-y-1">
                <h3 className="text-slate-900">Weekday vs Weekend</h3>
                <p className="text-slate-500">Average congestion patterns</p>
              </div>
              <div className="space-y-3">
                <div>
                  <div className="flex justify-between mb-1">
                    <span className="text-slate-600">Monday-Friday Average</span>
          ...
          <Card className="p-5 bg-red-50 border-red-200">
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-red-900">High Priority Zones for Intervention</h3>
              </div>
                  ...
                  .map((zone) => (
                    ...
                    >
                      <div className="flex justify-between items-start">
                        ...
                        <p className="text-red-600 text-xl">{zone.CongestionLevel}%</p>
                      </div>
      ...
      <Card className="p-4">
        <div className="flex items-center justify-center gap-6 flex-wrap">
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-600">Low (&lt;45%)</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded bg-yellow-500" />
            <span className="text-slate-600">Moderate (45-60%)</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded bg-orange-500" />
            <span className="text-slate-600">High (60-75%)</span>
          </div>
          <div className="flex items-center gap-2">
