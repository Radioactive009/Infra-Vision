...
import { FutureGrowthModel } from '../../../components/ai-features/models/FutureGrowthModel';
...
export default function FutureGrowthPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-orange-900">
