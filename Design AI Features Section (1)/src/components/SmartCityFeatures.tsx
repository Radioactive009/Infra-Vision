        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <motion.div className="hidden md:block" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button className="bg-gradient-to-r from-[#00A8E8] to-[#34D399] hover:from-[#0EA5E9] hover:to-[#22C55E] text-white px-6 py-2 rounded-full shadow-lg hover:shadow-xl transition-all duration-300">
                Get a Demo
              </Button>
            </motion.div>
              ...
              <div className="grid grid-cols-8 gap-1 md:gap-2 h-48 md:h-64">
                {[...Array(64)].map((_, i) => {
                  ...
                  if (activeMetricTab === 'Population') {
                    backgroundColor = randomValue > 0.7 ? `rgba(239,68,68,${intensity})` : 
                                     randomValue > 0.4 ? `rgba(59,130,246,${intensity})` : 
                                     `rgba(34,197,94,${intensity})`;
                  } else if (activeMetricTab === 'Economy') {
                    backgroundColor = randomValue > 0.6 ? `rgba(245,158,11,${intensity})` : 
                                     randomValue > 0.3 ? `rgba(0,168,232,${intensity})` : 
                                     `rgba(52,211,153,${intensity})`;
                  } else {
                    backgroundColor = randomValue > 0.5 ? `rgba(100,116,139,${intensity})` : 
      ...
      <footer className="bg-gray-900 text-white relative">
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; 2024 SmartCity AI. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
